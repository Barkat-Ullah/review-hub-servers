...
shurjopay.config(config_1.config.sp.sp_endpoint, config_1.config.sp.sp_username, config_1.config.sp.sp_password, config_1.config.sp.sp_prefix, config_1.config.sp.sp_return_url);
